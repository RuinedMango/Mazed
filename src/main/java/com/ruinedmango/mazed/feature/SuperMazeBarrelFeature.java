...
public class SuperMazeBarrelFeature extends Feature<NoneFeatureConfiguration> {

	public SuperMazeBarrelFeature(Codec<NoneFeatureConfiguration> codec) {
		super(codec);
